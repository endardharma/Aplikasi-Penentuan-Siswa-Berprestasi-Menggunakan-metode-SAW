...
class KeterlambatanSiswaController extends Controller
{
    ...
    public function listKeterlambatan(Request $request)
    {
        ...
        $query = KeterlambatanSiswa::with(['tajar','siswa','jurusan', 'konversiKeterlambatan'])
            ...
            ->when($search, function ($query) use ($search) {
                ...
                ->orWhereHas('konversiKeterlambatan', function ($q) use ($search) {
                    $q->where('jumlah_keterlambatan','LIKE','%'.$search.'%')
        ...
        foreach($keterlambatan as $k)
        {
            ...
            $item['id_konversi_keterlambatan_jumlah'] = $k->konversi_keterlambatan_id;
            $item['jumlah_keterlambatan'] = $k->konversiKeterlambatan->jumlah_keterlambatan ?? '';

            $item['id_konversi_keterlambatan_jumlah'] = $k->konversi_keterlambatan_id;
            $item['nilai'] = $k->konversiKeterlambatan->nilai_konversi ?? '';
    ...
    public function supportKonversiKeterlambatan()
    {
        $konversi = KonversiKeterlambatan::all();
        $data = array();
    ...
    public function tambahData(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'siswa_id' => 'required',
            'konversi_keterlambatan_id' => 'required',
            'jurusan_id' => 'required',
            'tajar_id' => 'required',
        ]); 
        ...
        $keterlambatan->konversi_keterlambatan_id = $request->konversi_keterlambatan_id;
    ...
    public function updateData(Request $request, $id)
    {
        ...
        else
        {
            ...
            $request->konversi_keterlambatan_id != null ? $find->konversi_keterlambatan_id = $request->konversi_keterlambatan_id : true;
