<table class="table table-striped">
    <thead>
        <tr>
            <th colspan="7" style="background-color: yellow; text-align:center; font-size: 30px; height: 50px; font-weight:50;"><b>Data Nilai Sikap Siswa</b></th>
        </tr>
        <tr>
            <th style="width: 200px; text-align:center; height: 40px;"><b>ID</b></th>
            <th style="width: 200px; text-align:center"><b>Nama Siswa</b></th>
            <th style="width: 200px; text-align:center"><b>Keterangan Sikap</b></th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align:left;">{{ $d['ket_sikap'] }} </td>
