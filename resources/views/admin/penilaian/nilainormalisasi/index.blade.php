...
<html lang="en">
    ...
    <head>
        ...
        <title>Nilai Normalisasi - Aplikasi PSB</title>
        <!-- BEGIN: CSS Assets-->
                    ...
                    <li class="desktop-penilaian">
                        ...
                        <ul class="">
                            ...
                            <li class="desktop-nilainormalisasi">
                                <a href="{{ route('penilaian.nilainormalisasi') }}" class="side-menu side-menu--active">
            ...
            <div class="content">
                ...
                <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Nilai Normalisasi</li>
                        </ol>
                    </nav>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Notifications -->
                ...
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    <h2 class="text-lg font-medium mr-auto">
                        List Nilai Normalisasi Jurusan MIPA
                    </h2>
                ...
                <div id="header-detail-footer-modal-preview-mipa" class="modal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <!-- BEGIN: Modal Header -->
                            <div class="modal-header">
                                <h2 class="font-medium text-base mr-auto">
                                    Detail Nilai Normalisasi MIPA
                                </h2>
                            ...
                            <div class="intro-y box p-5 mt-5">
                                <div class="overflow-x-auto scrollbar-hidden">
                                    <table id="data-table-detail-mipa" class="table table-striped" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Nama Siswa</th>
                ...
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    <h2 class="text-lg font-medium mr-auto">
                        List Nilai Normalisasi Jurusan IIS
                    </h2>
                </div>
                <!-- BEGIN: HTML Table Data -->
                <div class="intro-y box p-5 mt-5">
                ...
                <!-- END: HTML Table Data -->
                <!-- BEGIN: Modal Detail Content -->
                <div id="header-detail-footer-modal-preview-iis" class="modal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <!-- BEGIN: Modal Header -->
                            <div class="modal-header">
                                <h2 class="font-medium text-base mr-auto">
                                    Detail Nilai Normalisasi IIS
                                </h2>
                                <a href="javascript:;" data-tw-dismiss="modal"> <i data-feather="x" class="w-8 h-8 text-gray-500"></i> </a>
                            </div>
                            <!-- END: Modal Header -->
                            ...
                            <div class="intro-y box p-5 mt-5">
                                <div class="overflow-x-auto scrollbar-hidden">
                                    <table id="data-table-detail-iis" class="table table-striped" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Nama Siswa</th>
        ...
        <script>
            ...
            jQuery(document).ready(function() {
                ...
                jQuery('#data-table-mipa').dataTable({
                    ...
                    "serverSide": true,
                    "ajax":{
                        "url": 'http://127.0.0.1:8000/api/data-penilaian/nilai-normalisasi/list-normalisasi-mipa',
                        "dataType": 'json',
                        "type": 'POST',
                        "headers": {
                            'Authorization': 'Bearer ' + token
                    ...
                    "columns": [
                        ...
                        { data: 'tahun_ajar', className: 'text-center'},
                        {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    var detailBtn = '<button class="btn btn-warning btn-detail-mipa" data-id="' + data.id + '"><i data-feather="align-justify" class="w-4 h-4 mr-1"></i></button>';
                ...
                jQuery('#data-table-iis').dataTable({
                    ...
                    "serverSide": true,
                    "ajax":{
                        "url": 'http://127.0.0.1:8000/api/data-penilaian/nilai-normalisasi/list-normalisasi-iis',
                        "dataType": 'json',
                        "type": 'POST',
                        "headers": {
                            'Authorization': 'Bearer ' + token
                    ...
                    "columns": [
                        ...
                        { data: 'tahun_ajar', className: 'text-center'},
                        {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    // Create action buttons
                                    // var deleteBtn = '<button class="btn btn-danger btn-delete" data-id="' + data.id + '"><i data-feather="trash-2" class="w-4 h-4 mr-1"></i></button>';
                                    var detailBtn = '<button class="btn btn-warning btn-detail-iis" data-id="' + data.id + '"><i data-feather="align-justify" class="w-4 h-4 mr-1"></i></button>';
                ...
                jQuery('#data-table-mipa').on('click', '.btn-detail-mipa', function() {
                    var siswaId = jQuery(this).attr("data-id"); 

                    // Inisialisasi atau reset DataTable di dalam modal
                    var table = jQuery('#data-table-detail-mipa').DataTable({
                        "processing": true,
                        "serverSide": true,
                        "destroy": true, // Hapus DataTable yang sudah ada untuk menghindari duplikasi
                        "ajax": {
                            url: "http://127.0.0.1:8000/api/data-penilaian/nilai-normalisasi/list-detail-normalisasi-mipa",
                            type: "POST",
                            data: {
                    ...
                    // Tampilkan modal
                    const el = document.querySelector('#header-detail-footer-modal-preview-mipa');
