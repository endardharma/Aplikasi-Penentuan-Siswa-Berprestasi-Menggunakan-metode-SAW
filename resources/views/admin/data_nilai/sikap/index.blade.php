...
<html lang="en" class="light">
    ...
    <head>
        ...
        <title>Data Nilai Sikap - Aplikasi PSB</title>
        <!-- BEGIN: CSS Assets -->
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="">
                            ...
                            <li>
                                <a href="{{ route('data_nilai.sikap') }}" class="side-menu side-menu--active">
                ...
                <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Nilai Sikap Siswa</li>
                        </ol>
                    </nav>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Notifications -->
            ...
            <div id="header-import-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h2 class="font-medium text-base mr-auto">
                                Form Import Data Nilai Sikap Siswa
                            </h2>
                            <a data-tw-dismiss="modal" href="javascript:;"> <i data-feather="x" class="w-8 h-8 text-gray-500"></i> </a>
                        </div>
                        <!-- END: Modal Header -->
            ...
            <!-- END: Modal Content -->
            <!-- BEGIN: Notification Sukses Import Data sikap Siswa Content -->
            <div id="success-import-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="check-circle"></i> 
                <div class="ml-4 mr-4">
                    <div class="font-medium">Berhasil import data sikap siswa!</div>
                    <div class="text-slate-500 mt-1 import-sukses"></div>
                </div>
            </div>
            <!-- END: Notification Sukses Import Data sikap Siswa Content -->
            <!-- BEGIN: Notification Gagal Import Data sikap Siswa Content -->
            <div id="failed-import-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="x-circle"></i> 
                <div class="ml-4 mr-4">
                    <div class="font-medium">Gagal import data sikap siswa!</div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                            <div class="col-span-12 sm:col-span-12">
                                ...
                                <select class="form-select update-nama-siswa">
            ...
            <!-- END: Modal Content Form Update -->
            <!-- BEGIN: Notification Content Sukses Update Sikap Siswa -->
            <div id="success-update-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="check-circle"></i>
                <div class="ml-4 mr-4">
                    <div class="font-medium">Berhasil update data nilai sikap siswa!</div>
            ...
            <!-- END: Notification Content Gagal Update Sikap Siswa -->
                        ...
                        <div class="modal-body p-0">
                            <div class="p-5 text-center">
                                ...
                                <div class="text-slate-500 mt-2">
                                    ...
                                    <br>
                                    Data nilai sikap yang dihapus ini, tidak bisa dikembalikan.
                                </div>
                            </div>
            ...
            <!-- BEGIN: Notification Content Sukses Hapus Presensi -->
            <div id="success-hapus-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="check-circle"></i>
                <div class="ml-4 mr-4">
                    <div class="font-medium">Berhasil hapus data nilai sikap!</div>
            ...
            <!-- END: Notification Content Gagal Hapus Presensi -->
        </div>
        <!-- BEGIN: JS Asset -->
        ...
        <script>
            ...
            jQuery(document).ready(function(){
                ...
                // Data support siswa
                var url = 'http://127.0.0.1:8000/api/data-nilai/sikap-siswa/data-support/siswa';
                fetch(url, {
                    method: 'GET',
                    headers: {
                        'Authorization': 'Bearer ' + token
                ...
                // datatable list nilai sikap
                jQuery('#data-table').dataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": {
                        "url": "http://127.0.0.1:8000/api/data-nilai/sikap-siswa/list",
                        "dataType": "json",
                        "type": "POST",
                        "headers": {
                            'Authorization': 'Bearer ' + token
                    ...
                    "columns": [
                        ...
                        { data: 'nilai', className: 'text-center' },
                        {
                            ...
                            render: function(data, type, row){
                                ...
                                var editBtn = '<button class="btn btn-primary btn-edit" data-id="' + data.id + '" data-id_siswa_nama="' + data.id_siswa_nama + '" data-ket_sikap="' + data.ket_sikap + '" data-nilai="' + data.nilai + '"><i data-feather="edit" class="w-4 h-4 mr-1"></i></button>';
                ...
                jQuery('.btn-unduh').click(function() {
                    ...
                    var linkto = 'http://127.0.0.1:8000/api/data-nilai/sikap-siswa/export-data/download-template';
                    jQuery.ajax({
                        xhrFields: {
                            responseType: 'blob',
                        },
                        ...
                        success: function(result, status, xhr){
                            ...
                            var filename = (matches != null && matches[1] ? matches[1] : 'Template-Sikap-Siswa.xlsx');
                ...
                jQuery('.btn-update').click(function(){
                    ...
                    jQuery.ajax({
                        url: 'http://127.0.0.1:8000/api/data-nilai/sikap-siswa/update-data/' + id,
                        type: 'PUT',
                ...
                jQuery('#data-table').on('click', '.btn-delete', function(){
                    ...
                    jQuery('.btn-iya').click(function(){
                        // ajax delete API
                        jQuery.ajax({
                            url: 'http://127.0.0.1:8000/api/data-nilai/sikap-siswa/hapus-data/' + id,
                            type: 'DELETE',
                            headers: {
                                'Authorization': 'Bearer ' + token
                            },
                ...
                jQuery('.btn-import').click(function(){
                    ...
                    // Kirim permintaan pembaruan produk ke API
                    jQuery.ajax({
                        url: 'http://127.0.0.1:8000/api/data-nilai/sikap-siswa/import-data/import-xls',
                        type: 'POST',
                        headers: {
                            "Authorization": "Bearer " + token
                        },
                ...
                jQuery('.btn-export').click(function() {
                    // Akses URL Export data
                    var linkto = 'http://127.0.0.1:8000/api/data-nilai/sikap-siswa/export-data/export-xls';
                    jQuery.ajax({
                        xhrFields: {
                            responseType: 'blob',
                        },
                        ...
                        success: function(result, tahun_ajar, xhr){
                            ...
                            var disposition = xhr.getResponseHeader('contet-disposition');
                            var matches = /"([^"]*)"/.exec(disposition);
                            var filename = (matches != null && matches[1] ? matches[1] : 'Export-Sikap-Siswa.xlsx');
