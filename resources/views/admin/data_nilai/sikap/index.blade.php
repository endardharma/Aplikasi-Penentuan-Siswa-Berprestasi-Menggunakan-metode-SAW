        ...
        <script>
            ...
            jQuery(document).ready(function(){
                ...
                jQuery('.btn-unduh-mipa').click(function() {
                    ...
                    var linkto = 'http://127.0.0.1:8000/api/data-nilai/sikap-siswa/export-data/download-template-mipa';
                    jQuery.ajax({
                        xhrFields: {
                            responseType: 'blob',
                        },
                        ...
                        success: function(result, status, xhr){
                            ...
                            var filename = (matches != null && matches[1] ? matches[1] : 'Template-Sikap-Siswa-Mipa.xlsx');
                ...
                jQuery('.btn-unduh-iis').click(function() {
                    // Akses URL Export data
                    var linkto = 'http://127.0.0.1:8000/api/data-nilai/sikap-siswa/export-data/download-template-iis';
                    jQuery.ajax({
                        xhrFields: {
                            responseType: 'blob',
                        },
                        ...
                        success: function(result, status, xhr){
                            ...
                            var disposition = xhr.getResponseHeader('content-disposition');
                            var matches = /"([^"]*)"/.exec(disposition);
                            var filename = (matches != null && matches[1] ? matches[1] : 'Template-Sikap-Siswa-Iis.xlsx');
