        ...
        <script>
            ...
            jQuery(document).ready(function(){
                ...
                jQuery('.btn-unduh').click(function() {
                    ...
                    var linkto = 'http://127.0.0.1:8000/api/data-nilai/keterlambatan-siswa/export-data/download-template';
                    jQuery.ajax({
                        xhrFields: {
                            responseType: 'blob',
                        },
                        ...
                        success: function(result, status, xhr){
                            ...
                            var filename = (matches != null && matches[1] ? matches[1] : 'Template-Keterlambatan-Siswa.xlsx');
