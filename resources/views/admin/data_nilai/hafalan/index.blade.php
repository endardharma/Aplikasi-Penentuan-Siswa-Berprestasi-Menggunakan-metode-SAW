...
<html lang="en" class="light">
    ...
    <head>
        ...
        <title>Data Nilai Hafalan - Aplikasi PSB</title>
        <!-- BEGIN: CSS Assets-->
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
                ...
                <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Nilai Hafalan Siswa</li>
                        </ol>
                    </nav>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Notifications -->
            ...
            <div id="header-create-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <!-- BEGIN: Modal Header -->
                        <div class="modal-header">
                            <h2 class="font-medium text-base mr-auto">
                                Form Tambah Data Nilai Hafalan Siswa
                            </h2>
                        ...
                        <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                            <div class="col-span-12 sm:col-span-12">
                                ...
                                <input type="hidden" class="form-control create-id">
                                <select class="form-select create-nama-siswa" required>
                                    <option disabled selected> --- Pilih Nama Siswa --- </option>
                                </select>
                            </div>
                            <div class="col-span-12 sm:col-span-12">
                                <label for="modal-form-2" class="form-label">Keterangan Hafalan</label>
                                <select class="form-select create-ket-hafalan">
                                    <option selected disabled> --- Pilih Keterangan Hafalan --- </option>
                                    <option value="Jumlah Juz">Jumlah Juz</option>
                                    <option value="Makhrodul Huruf">Makhrodul Huruf</option>
                                    <option value="Ketentuan Ilmu Tajwin">Ketentuan Ilmu Tajwin</option>
                                    <option value="Irama/Lagu">Irama/Lagu</option>
                                    <option value="Fasokhah">Fasokhah</option>
                                </select>
                            </div>
                            <div class="col-span-12 sm:col-span-12">
                                <label for="modal-form-1" class="form-label">Nilai</label>
                                <input type="number" class="form-control create-nilai" placeholder="Masukkan Nilai Hafalan" required>
                            </div>
                            <div class="col-span-12 sm:col-span-12">
            ...
            <!-- BEGIN: Notification Content Sukses create Hafalan -->
            <div id="success-create-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="check-circle"></i>
                <div class="ml-4 mr-4">
                    <div class="font-medium">Berhasil menambahkan data nilai hafalan!</div>
                    <div class="text-slate-500 mt-1 create-sukses"></div>
                </div>
            </div>
            <!-- END: Notification Content Sukses create Hafalan -->
            <!-- BEGIN: Notification Content Gagal create Hafalan -->
            <div id="failed-create-notification-content" class="toastify-content hidden flex">
                <i class="text-danger" data-lucide="x-circle"></i>
                <div class="ml-4 mr-4">
                    <div class="font-medium">Gagal menambahkan data nilai hafalan!</div>
                    <div class="text-slate-500 mt-1 create-gagal"></div>
                </div>
            </div>
            <!-- END: Notification Content Gagal Update Hafalan -->
            ...
            <div id="header-update-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h2 class="font-medium text-base mr-auto">
                                Form Update Data Nilai Hafalan Siswa
                            </h2>
                            <a href="javascript:;" data-tw-dismiss="modal"> <i data-feather="x" class="w-8 h-8 text-gray-500"></i> </a>
                        </div>
                        <!-- END: Modal Header -->
                        ...
                        <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                            ...
                            <div class="col-span-12 sm:col-span-12">
                                <label for="modal-form-2" class="form-label">Keterangan Hafalan</label>
                                {{-- <input type="text" class="form-control update-ket-hafalan" placeholder="Masukkan Keterangan Hafalan" required> --}}
                                <select class="form-select update-ket-hafalan">
                                    <option selected disabled> --- Pilih Keterangan Hafalan --- </option>
                                    <option value="Jumlah Juz">Jumlah Juz</option>
                                    <option value="Makhrodul Huruf">Makhrodul Huruf</option>
                                    <option value="Ketentuan Ilmu Tajwin">Ketentuan Ilmu Tajwin</option>
            ...
            <!-- BEGIN: Notification Content Sukses Update Hafalan -->
            <div id="success-update-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="check-circle"></i>
                <div class="ml-4 mr-4">
                    <div class="font-medium">Berhasil update data nilai hafalan!</div>
                    <div class="text-slate-500 mt-1 update-sukses"></div>
                </div>
            </div>
            <!-- END: Notification Content Sukses Update Hafalan -->
            <!-- BEGIN: Notification Content Gagal Update Hafalan -->
            <div id="failed-update-notification-content" class="toastify-content hidden flex">
                <i class="text-danger" data-lucide="x-circle"></i>
                <div class="ml-4 mr-4">
                    <div class="font-medium">Gagal update data nilai hafalan!</div>
                        ...
                        <div class="modal-body p-0">
                            <div class="p-5 text-center">
                                ...
                                <div class="text-slate-500 mt-2">
                                    Apa kamu yakin akan menghapus data nilai hafalan ini ?
                                    <br>
                                    Data nilai hafalan yang dihapus ini, tidak bisa dikembalikan.
                                </div>
                            </div>
            ...
            <!-- BEGIN: Notification Sukses Hapus Hafalan Content -->
            <div id="success-hapus-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="check-circle"></i> 
                <div class="ml-4 mr-4">
                    <div class="font-medium">Berhasil hapus data nilai hafalan!</div>
                    <div class="text-slate-500 mt-1 hapus-sukses"></div>
                </div>
            </div>
            <!-- END: Notification Sukses Hapus Hafalan Content -->
            <!-- BEGIN: Notification Gagal Hapus Hafalan Content -->
            <div id="failed-hapus-notification-content" class="toastify-content hidden flex">
                <i class="text-danger" data-lucide="x-circle"></i> 
                <div class="ml-4 mr-4">
                    <div class="font-medium">Gagal hapus data nilai hafalan!</div>
                    <div class="text-slate-500 mt-1 hapus-gagal"></div>
                </div>
            </div>
            <!-- END: Notification Gagal Hapus Hafalan Content -->
            <!-- BEGIN: Modal Content -->
            <div id="header-import-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h2 class="font-medium text-base mr-auto">
                                Form Import Data Nilai Hafalan Siswa
                            </h2>
                            <a data-tw-dismiss="modal" href="javascript:;"> <i data-feather="x" class="w-8 h-8 text-gray-500"></i> </a>
                        </div>
                        <!-- END: Modal Header -->
            ...
            <!-- END: Modal Content -->
            <!-- BEGIN: Notification Sukses Import Data hafalan Siswa Content -->
            <div id="success-import-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="check-circle"></i> 
                <div class="ml-4 mr-4">
                    <div class="font-medium">Berhasil import data hafalan siswa!</div>
                    <div class="text-slate-500 mt-1 import-sukses"></div>
                </div>
            </div>
            <!-- END: Notification Sukses Import Data hafalan Siswa Content -->
            <!-- BEGIN: Notification Gagal Import Data hafalan Siswa Content -->
            <div id="failed-import-notification-content" class="toastify-content hidden flex">
                <i class="text-danger" data-lucide="x-circle"></i> 
                <div class="ml-4 mr-4">
                    <div class="font-medium">Gagal import data hafalan siswa!</div>
                    <div class="text-slate-500 mt-1 import-gagal"></div>
                </div>
            </div>
            <!-- END: Notification Gagal Import Data hafalan Siswa Content -->
        </div>
        ...
        <script>
            ...
            jQuery(document).ready(function() {
                        ...
                        columns: [
                            ...
                            { data: 'tahun_ajar', className: 'text-center' },
                            {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    var editBtn = '<button class="btn btn-primary btn-edit" data-id="' + data.id + '" data-id_siswa_nama="' + data.id_siswa_nama + '" data-ket_hafalan="' + data.ket_hafalan + '" data-nilai="' + data.nilai + '" data-id_jurusan_nama="' + data.id_jurusan_nama + '" data-id_tajar_periode="' + data.id_tajar_periode + '"><i data-feather="edit" class="w-4 h-4 mr-1"></i></button>';
                ...
                jQuery('.btn-tambah').click(function(){
                    const el = document.querySelector("#header-create-footer-modal-preview");
                    const modal = tailwind.Modal.getOrCreateInstance(el);
                    modal.show();
                });
                ...
                // Data Support Tajar
                var url = 'http://127.0.0.1:8000/api/data-nilai/hafalan-siswa/data-support/tajar';
                fetch(url, {
                    method: 'GET',
                    headers: {
                        'Authorization': 'Bearer ' + token
                    ...
                    var selectCreate = jQuery('.create-tahun-ajar');
                    var selectUpdate = jQuery('.update-tahun-ajar');
                    ...
                    jQuery.each(data, function(index, item){
                        for(let i = 0; i < item.length; i++)
                        {
                            ...
                            selectCreate.append('<option value="' + item[i].id + '">' + item[i].periode + '</option>');
                ...
                // Data Support Siswa
                var url = 'http://127.0.0.1:8000/api/data-nilai/hafalan-siswa/data-support/siswa';
                fetch(url, {
                    method: 'GET',
                    headers: {
                        'Authorization': 'Bearer ' + token
                ...
                jQuery('.btn-unduh-mipa').click(function(){
                    ...
                    var linkto = 'http://127.0.0.1:8000/api/data-nilai/hafalan-siswa/export-data/download-template-mipa';
                    jQuery.ajax({
                        xhrFields: {
                            responseType: 'blob',
                        },
                        ...
                        success: function(result, status, xhr){
                            ...
                            var filename = (matches != null && matches[1] ? matches[1] : 'Template-Hafalan-Siswa-Mipa.xlsx');
                ...
                jQuery('.btn-unduh-iis').click(function(){
                    // Akses URL Export Data
                    var linkto = 'http://127.0.0.1:8000/api/data-nilai/hafalan-siswa/export-data/download-template-iis';
                    jQuery.ajax({
                        xhrFields: {
                            responseType: 'blob',
                        },
                        ...
                        success: function(result, status, xhr){
                            ...
                            var disposition = xhr.getResponseHeader('content-disposition');
                            var matches = /"([^"]*)"/.exec(disposition);
                            var filename = (matches != null && matches[1] ? matches[1] : 'Template-Hafalan-Siswa-Iis.xlsx');
                ...
                jQuery('.btn-simpan').click(function(){
                    ...
                    var ket_hafalan = jQuery('.create-ket-hafalan').val();
                    ...
                    formData.append('ket_hafalan', ket_hafalan);
                    ...
                    // kirim ke API
                    jQuery.ajax({
                        url: 'http://127.0.0.1:8000/api/data-nilai/hafalan-siswa/tambah-data',
                        type: 'POST',
                        headers: {
                            'Authorization': 'Bearer ' + token,
                        },
                ...
                jQuery('#data-table-detail').on('click', '.btn-edit', function() {
                    ...
                    var ket_hafalan = jQuery(this).attr("data-ket_hafalan");
                ...
                jQuery('.btn-update').click(function(){
                    ...
                    jQuery.ajax({
                        url: 'http://127.0.0.1:8000/api/data-nilai/hafalan-siswa/update-data/' + id,
                        type: 'PUT',
                ...
                jQuery('#data-table').on('click', '.btn-delete', function(){
                    ...
                    jQuery('.btn-iya').click(function(){
                        // ajax delete API
                        jQuery.ajax({
                            url: 'http://127.0.0.1:8000/api/data-nilai/hafalan-siswa/hapus-data/' + id,
                            type: 'DELETE',
                            headers: {
                                'Authorization': 'Bearer ' + token
                            },
                ...
                jQuery('#data-table-detail').on('click', '.btn-delete-detail', function(){
                    ...
                    jQuery('.btn-iya').click(function(){
                        // ajax delete API
                        jQuery.ajax({
                            url: 'http://127.0.0.1:8000/api/data-nilai/hafalan-siswa/hapus-data-detail/' + id,
                            type: 'DELETE',
                            headers: {
                                'Authorization': 'Bearer ' + token
                            },
                ...
                jQuery('.btn-import').click(function(){
                    ...
                    // Kirim permintaan pembaruan produk ke API
                    jQuery.ajax({
                        url: 'http://127.0.0.1:8000/api/data-nilai/hafalan-siswa/import-data/import-xls',
                        type: 'POST',
                        headers: {
                            "Authorization": "Bearer " + token
                        },
