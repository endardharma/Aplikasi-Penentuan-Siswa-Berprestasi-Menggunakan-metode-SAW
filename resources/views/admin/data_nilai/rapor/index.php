    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                            <div class="col-span-12 sm:col-span-12">
                                ...
                                <input type="text" class="form-control update-nama_siswa" placeholder="Isi dengan Nama Siswa" required>
                            </div>
                            <div class="col-span-12 sm:col-span-12">
                                <label for="modal-form-2" class="form-label">Nama Mapel</label>
                                <select class="form-select update-nama_mapel" required>
                            ...
                            <div class="col-span-12 sm:col-span-12">
                                <label for="modal-form-2" class="form-label">Tipe Mapel</label>
                                <select class="form-select update-type" required>
                                    <option disabled selected> --- Pilih Tipe Pelajaran ---</option>
                                </select>
                            </div>
                            <div class="col-span-12 sm:col-span-12">
                                <label for="modal-form-1" class="form-label">Nilai</label>
                                <input type="number" class="form-control update-nilai" placeholder="Isi dengan Nilai Mata Pelajaran" required>
                            </div>
                            <div class="col-span-12 sm:col-span-12">
                            ...
                            <div class="col-span-12 sm:col-span-12">
                                ...
                                <select class="form-select update-semester" required>
                                    <option disabled selected> --- Pilih Semester Siswa ---</option>
                                </select>
                            </div>
                            <div class="col-span-12 sm:col-span-12">
                                <label for="modal-form-2" class="form-label">Tahun Ajar</label>
                                <select class="form-select update-tahun_ajar" required>
                                    <option disabled selected> --- Pilih Tahun Ajar Siswa ---</option>
                                </select>
                            </div>
                        </div>
                        <!-- END: Modal Body -->
            ...
            <div id="success-update-notification-content" class="toastify-content hidden flex">
                ...
                <div class="ml-4 mr-4">
                    <div class="font-medium">Berhasil update data nilai rapor siswa!</div>
            ...
            <div id="failed-update-notification-content" class="toastify-content hidden flex">
                ...
                <div class="ml-4 mr-4">
                    <div class="font-medium">Gagal update data nilai rapor siswa!</div>
                        ...
                        <div class="modal-body p-0">
                            <div class="p-5 text-center">
                                ...
                                <div class="text-slate-500 mt-2">
                                    Apa kamu yakin akan menghapus data rapor ini? 
                                    <br>
                                    Data rapor yang dihapus ini, tidak bisa dikembalikan.
                                </div>
                            </div>
            ...
            <div id="success-hapus-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="check-circle"></i> 
                <div class="ml-4 mr-4">
                    <div class="font-medium">Berhasil hapus data nilai rapor siswa!</div>
            ...
            <div id="failed-hapus-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="x-circle"></i> 
                <div class="ml-4 mr-4">
                    <div class="font-medium">Gagal hapus data nilai rapor siswa!</div>
            ...
            <!-- END: Modal Content -->
            <!-- BEGIN: Notification Sukses Nilai Rapor Siswa Content -->
            <div id="success-import-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="check-circle"></i> 
                <div class="ml-4 mr-4">
                    <div class="font-medium">Berhasil import data nilai rapor siswa!</div>
                    <div class="text-slate-500 mt-1 import-sukses"></div>
                </div>
            </div>
            <!-- END: Notification Sukses Nilai Rapor Siswa Content -->
            <!-- BEGIN: Notification Gagal Nilai Rapor Siswa Content -->
            <div id="failed-import-notification-content" class="toastify-content hidden flex">
                <i class="text-success" data-lucide="x-circle"></i> 
                <div class="ml-4 mr-4">
                    <div class="font-medium">Gagal import data nilai rapor siswa!</div>
                    <div class="text-slate-500 mt-1 import-gagal"></div>
                </div>
            </div>
            <!-- END: Notification Gagal Nilai Rapor Siswa Content -->
        </div>
        ...
        jQuery(document).ready(function(){
            ...
            fetch(url, {
                ...
                var selectUpdate = jQuery('.update-tahun_ajar');
                ...
                jQuery.each(data, function(index, item) {
                    for (let i = 0; i < item.length; i++) {
                        ...
                        selectUpdate.append('<option value="' + item[i].id + '">' + item[i].tahun + '</option>');
            ...
            fetch(url, {
                ...
                // panggil element select
                var selectUpdateNama = jQuery('.update-nama_mapel');
                ...
                "columns": [
                    ...
                    { data: 'nilai', className: 'text-center' },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            var editBtn = '<button class="btn btn-primary btn-edit" data-id="' + data.id + '" data-nama_siswa="' + data.nama_siswa + '" data-nama_mapel="' + data.nama_mapel + '" data-kelompok="' + data.kelompok + '" data-type="' + data.type + '" data-nilai="' + data.nilai + '"  data-jurusan="' + data.jurusan + '"  data-semester="' + data.semester + '" data-tahun_ajar="' + data.tahun_ajar + '" ><i data-feather="edit" class="w-4 h-4 mr-1"></i></button>';
            ...
            // Datatable Detail list nilai raport siswa
            ...
            jQuery('#data-table').on('click', '.btn-edit', function() {
                ...
                var nama_siswa = jQuery(this).attr("data-nama_siswa");
                var nama_mapel = jQuery(this).attr("data-nama_mapel");
                ...
                var tahun_ajar = jQuery(this).attr("data-tahun_ajar");

                // Handle edit action
                jQuery('.update-id').val(id);
                jQuery('.update-nama_siswa').val(nama_siswa).prop('disabled',true);
                jQuery('.update-nama_mapel').val(nama_mapel);
                ...
                jQuery('.update-tahun_ajar').val(tahun_ajar);
            });
            ...
            jQuery('.btn-update').click(function() {
                ...
                var nama_siswa = jQuery('.update-nama_siswa').val();
                var nama_mapel = jQuery('.update-nama_mapel').val();
                ...
                var tahun_ajar = jQuery('.update-tahun_ajar').val();

                // Kirim permintaan pembaruan produk ke API
                jQuery.ajax({
                    url: 'http://127.0.0.1:8000/api/data-nilai/update-data/' + id,
                    type: "PUT",
            ...
            jQuery('.btn-export').click(function() {
                ...
                jQuery.ajax({
                    ...
                    success: function(result, tahun_ajar, xhr) {
                        ...
                        var filename = (matches != null && matches[1] ? matches[1] : 'Export-Data-Raport-Siswa.xlsx');
            ...
            //             var disposition = xhr.getResponseHeader('content-disposition');
            //             var matches = /"([^"]*)"/.exec(disposition);
            //             var filename = (matches != null && matches[1] ? matches[1] : 'Template-Raport-Siswa.xlsx');
